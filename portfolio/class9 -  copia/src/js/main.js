...
function select(element) {
    var optionName = element.textContent.trim();

    element.style.animation = "selectoption 0.2s cubic-bezier(0.86, 0, 0.07, 1) forwards";
    element.style.webkitAnimation = "selectoption 0.2s cubic-bezier(0.86, 0, 0.07, 1) forwards";
...
function goScreen(name) {
    ...
    switch (myName) {
        ...
        default:
            console.log("Opción no reconocida:", myName);
            break;
    }
}
